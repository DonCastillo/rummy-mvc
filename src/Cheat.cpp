    ...
    else
    {
        ...
        if(callCheat < players.size())
        {
            ...
            if(caught)
            {
                ...
                currentPlayer->getHand()->insert(currentPlayer->getHand()->begin(), pile.begin(), pile.end());

            }
            else
            {
                players[callCheat]->getHand()->insert(players[callCheat]->getHand()->begin(), pile.begin(), pile.end());
            }
            pile.clear();
        }
        else
